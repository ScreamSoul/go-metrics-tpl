...
//go:generate minimock -i github.com/screamsoul/go-metrics-tpl/internal/repositories.MetricStorage -o metric_storage_mock.go -n MetricStorageMock -p repositories
